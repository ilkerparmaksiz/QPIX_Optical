...
G4MaterialPropertiesTable* OpticalMaterialProperties::OpticalLAr()
{
  ...
  LAr_mpt->AddConstProperty("SCINTILLATIONYIELD", 10000/MeV);
  LAr_mpt->AddConstProperty("RESOLUTIONSCALE", 1);
  LAr_mpt->AddConstProperty("RAYLEIGH", 95.*cm,true);
  ...
  LAr_mpt->AddConstProperty("SCINTILLATIONTIMECONSTANT2", 1590.*ns);
  //LAr_mpt->AddConstProperty("SCINTILLATIONYIELD1", .1);
  //LAr_mpt->AddConstProperty("SCINTILLATIONYIELD2", .9);
  //LAr_mpt->AddConstProperty("IONIZATIONYIELD", 42372.9/MeV);
  //LAr_mpt->AddConstProperty("FANOFACTOR", 0.107,true);
 ...
 //LAr_mpt->AddConstProperty("YIELDRATIO", 0.84);
  LAr_mpt->AddConstProperty("SCINTILLATIONYIELD1", .16);
  LAr_mpt->AddConstProperty("SCINTILLATIONYIELD2", .84);
